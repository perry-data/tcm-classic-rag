...
本轮已按 [dense_retrieval_upgrade_spec.md](/Users/man_ray/Projects/Python/tcm-classic-rag/docs/archive/dense_retrieval_upgrade_spec.md) 实现最小 Hybrid 检索闭环：

- dense index 构建：[build_dense_index.py](/Users/man_ray/Projects/Python/tcm-classic-rag/scripts/build_dense_index.py)
- hybrid retrieval：[hybrid.py](/Users/man_ray/Projects/Python/tcm-classic-rag/backend/retrieval/hybrid.py)
- dense index 产物：
