# Risks and Manual Review Points v2

Remaining risk families include annotation_anchor_uncertain, uncertain_usage_context, source_span_coarse, source-span incomplete parents for 00594/00465, and parser reclassification planning for batch_007.
These blockers keep Macro Phase 2.1 in progress and keep runtime gates closed.
Phase 2.6 can only apply the audited 7 Batch-1 rows after explicit approval and still cannot authorize runtime or shadow retrieval.
