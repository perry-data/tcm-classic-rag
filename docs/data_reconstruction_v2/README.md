# Data Reconstruction v2 Spec Landing README

This directory is the canonical documentation landing area for ZJSHL v2 reconstruction after the roadmap rebaseline.
Macro Phase 2.2, Phase 3, and Phase 4 remain not started.
Phase 2.6 is paused until explicit user approval after this checkpoint.
