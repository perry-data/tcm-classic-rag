# Data Cutting Audit Report v2

The credible raw source is data/raw/《注解伤寒论》.zip, recorded by the handoff inventory and reused by Phase 2.0.
Phase 2.0 parsed 1,864 raw items into object ledgers and review queues without changing runtime data.
Appendix, preface, index, review-only, and ambiguous materials stay outside primary lanes unless a later audited rule promotes them.
