# Retrieval Ready View Spec v2

Retrieval-ready files are generated as sidecar JSONL views during reconstruction snapshots.
Primary eligibility is controlled by primary_allowed, display_allowed, review_only, evidence_level, risk_flags, and relation/source-object existence checks.
Review-only materials and raw full passage carriers do not become primary evidence.
