# Pilot Reconstruction Plan v2

The pilot phase builds an isolated sidecar under artifacts/data_reconstruction_v2/pilot_build/ and validates object QA without runtime wiring.
Phase 1.2/1.3 pilot rules were carried forward into Phase 2.0 as working spec because structured Phase 1.4 files were missing.
Future pilot changes must remain artifact-local unless the user explicitly opens runtime integration.
