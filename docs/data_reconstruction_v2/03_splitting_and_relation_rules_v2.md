# Splitting and Relation Rules v2

Relation outputs include formula_has_formula_text, formula_text_in_source_section, main_text_has_annotation, annotation_comments_on_main_text, formula_has_usage_context, term occurrence, definition support, editorial attachment, and ambiguous parent suspicion relations.
Negative/prohibition rows are excluded from positive formula_usage primary evidence.
Formula_text anchors can be applied only from explicit audited rows; broad annotation auto-promotion is not allowed.
