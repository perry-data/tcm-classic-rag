...
- 新增 `general_question_strategy.py`
- 识别 `怎么办 / 怎么处理 / 有哪些情况 / 有什么分支` 等总括触发词
- 排除比较问答、方名直问这类不应进入总括路径的问题

2. 总括类回答编排

- 在 [run_answer_assembler.py](/Users/man_ray/Projects/Python/tcm-classic-rag/run_answer_assembler.py) 新增 general-question 分支
...
- [general_question_strategy.py](/Users/man_ray/Projects/Python/tcm-classic-rag/general_question_strategy.py)
- [run_answer_assembler.py](/Users/man_ray/Projects/Python/tcm-classic-rag/run_answer_assembler.py)
