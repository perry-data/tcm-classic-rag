...
- [ ] `run_hybrid_retrieval.py` 能产出 `artifacts/hybrid_retrieval_examples.json`
- [ ] `run_hybrid_retrieval.py` 能产出 `artifacts/hybrid_retrieval_smoke_checks.md`
- [ ] `run_answer_assembler.py` 能产出 `artifacts/hybrid_answer_examples.json`
- [ ] `run_answer_assembler.py` 能产出 `artifacts/hybrid_answer_smoke_checks.md`
