...
- generated_at_utc: `2026-04-08T10:09:50.154862+00:00`
...
- command: `python scripts/run_evaluator_v1.py --goldset artifacts/evaluation/goldset_v2_working_102.json --report-json artifacts/evaluation/goldset_v2_batchA_eval_report.json --report-md artifacts/evaluation/goldset_v2_batchA_eval_report.md`
...
- total_questions: `102`
- mode_match_count: `89/102`
- mode_match_rate: `0.8725`
- citation_check_required_basic_pass: `79/82`
- failure_count: `13`
...
- actual_mode_counts: `{"refuse": 16, "strong": 60, "weak_with_review_notice": 26}`

## 题型统计

| question_type | total | mode_match | citation_required | citation_basic_pass | failures |
| --- | ---: | ---: | ---: | ---: | ---: |
| `comparison` | 20 | 18 | 20 | 18 | 2 |
...
| `eval_seed_q085` | `comparison` | `strong` | `refuse` | FAIL | 0 | FAIL | PASS | PASS | PASS | PASS |
...
| `eval_seed_q090` | `comparison` | `strong` | `refuse` | FAIL | 0 | FAIL | PASS | PASS | PASS | PASS |
...
| `eval_seed_q097` | `refusal` | `refuse` | `strong` | FAIL | 3 | PASS | FAIL | FAIL | FAIL | FAIL |
| `eval_seed_q098` | `refusal` | `refuse` | `weak_with_review_notice` | FAIL | 5 | PASS | PASS | FAIL | FAIL | FAIL |
| `eval_seed_q099` | `refusal` | `refuse` | `strong` | FAIL | 3 | PASS | FAIL | FAIL | FAIL | FAIL |
| `eval_seed_q100` | `refusal` | `refuse` | `weak_with_review_notice` | FAIL | 8 | PASS | PASS | FAIL | FAIL | FAIL |
| `eval_seed_q101` | `refusal` | `refuse` | `weak_with_review_notice` | FAIL | 5 | PASS | PASS | FAIL | FAIL | FAIL |
| `eval_seed_q102` | `refusal` | `refuse` | `weak_with_review_notice` | FAIL | 5 | PASS | PASS | FAIL | FAIL | FAIL |
...
- actual_mode: `strong`
- failed_checks: `mode_match, primary_empty_check, zero_evidence_check, zero_citations_check, unsupported_assertion_check`
- unsupported_assertion_failure_reasons: `must_refuse_but_actual_mode_not_refuse, expected_refuse_but_actual_mode_not_refuse, primary_evidence_should_be_empty, evidence_should_be_zero, citations_should_be_zero, strong_without_gold_evidence`
...
- expected_mode: `refuse`
- actual_mode: `weak_with_review_notice`
- failed_checks: `mode_match, zero_evidence_check, zero_citations_check, unsupported_assertion_check`
- unsupported_assertion_failure_reasons: `must_refuse_but_actual_mode_not_refuse, expected_refuse_but_actual_mode_not_refuse, evidence_should_be_zero, citations_should_be_zero`
