...
- generated_at_utc: `2026-04-08T12:01:14.104404+00:00`
...
- command: `python scripts/run_evaluator_v1.py --goldset artifacts/evaluation/goldset_v2_working_102.json --report-json artifacts/evaluation/general_overview_finish_fix_v1_eval_report.json --report-md artifacts/evaluation/general_overview_finish_fix_v1_eval_report.md`
...
- mode_match_rate: `1.0`
- citation_check_required_basic_pass: `82/82`
- failure_count: `0`
...
- actual_mode_counts: `{"refuse": 20, "strong": 63, "weak_with_review_notice": 19}`
...
| `general_overview` | 14 | 14 | 14 | 14 | 0 |
| `meaning_explanation` | 18 | 18 | 18 | 18 | 0 |
| `refusal` | 20 | 20 | 0 | 0 | 0 |
| `source_lookup` | 30 | 30 | 30 | 30 | 0 |
