...
- generated_at_utc: `2026-04-24T05:18:20.102456+00:00`
...
| --- | --- | --- | --- | --- | --- | --- |
| similar_05 | similar_concept_false_trigger | 刚痓和柔痓有什么不同 | weak_with_review_notice | 刚痓,柔痓 | - | wrong AHV term normalization: 刚痓,柔痓 |
| similar_06 | similar_concept_false_trigger | 柔痓和痓病是一回事吗 | strong | 柔痓,痓病 | - | wrong AHV term normalization: 柔痓,痓病 |
| similar_07 | similar_concept_false_trigger | 痉病和痓病是同一个词吗 | weak_with_review_notice | 痓病 | - | wrong AHV term normalization: 痓病 |
| similar_09 | similar_concept_false_trigger | 结脉和促脉有什么区别 | strong | 结脉,促脉 | - | wrong AHV term normalization: 结脉,促脉 |
| similar_11 | similar_concept_false_trigger | 滑脉和革脉有什么不同 | weak_with_review_notice | 滑脉,革脉 | - | wrong AHV term normalization: 滑脉,革脉 |
| similar_14 | similar_concept_false_trigger | 劳复和食复一样吗 | strong | 劳复,食复 | - | wrong AHV term normalization: 劳复,食复 |
| similar_17 | similar_concept_false_trigger | 伤寒和温病有什么区别 | strong | 伤寒,温病 | - | wrong AHV term normalization: 伤寒,温病 |
| similar_18 | similar_concept_false_trigger | 伤寒和暑病有什么区别 | strong | 伤寒,暑病 | - | wrong AHV term normalization: 伤寒,暑病 |
| similar_19 | similar_concept_false_trigger | 伤寒和冬温有什么区别 | strong | 伤寒,冬温 | - | wrong AHV term normalization: 伤寒,冬温 |
| similar_20 | similar_concept_false_trigger | 太阳病和伤寒是一回事吗 | strong | 太阳病,伤寒 | - | wrong AHV term normalization: 太阳病,伤寒 |
| disabled_alias_02 | disabled_alias_recheck | 暑病者是什么意思 | strong | - | 暑病 | wrong AHV primary hit: 暑病 |
| disabled_alias_03 | disabled_alias_recheck | 寒疫是什么意思 | strong | - | 时行寒疫 | wrong AHV primary hit: 时行寒疫 |
| non_definition_01 | non_definition_intent | 太阳病有哪些方？ | strong | 太阳病 | - | wrong AHV term normalization: 太阳病 |
| non_definition_02 | non_definition_intent | 伤寒怎么治疗？ | strong | 伤寒 | - | wrong AHV term normalization: 伤寒 |
| non_definition_03 | non_definition_intent | 温病与伤寒如何区分？ | strong | 温病,伤寒 | - | wrong AHV term normalization: 温病,伤寒 |
| non_definition_04 | non_definition_intent | 霍乱用什么方？ | strong | 霍乱 | - | wrong AHV term normalization: 霍乱 |
| non_definition_05 | non_definition_intent | 劳复应该怎么处理？ | strong | 劳复 | - | wrong AHV term normalization: 劳复 |
| non_definition_06 | non_definition_intent | 食复怎么治？ | strong | 食复 | - | wrong AHV term normalization: 食复 |
| non_definition_07 | non_definition_intent | 结脉有什么方？ | strong | 结脉 | - | wrong AHV term normalization: 结脉 |
| non_definition_08 | non_definition_intent | 革脉预后如何？ | refuse | 革脉 | - | wrong AHV term normalization: 革脉 |
...
| similar_05 | similar_concept_false_trigger | 刚痓和柔痓有什么不同 | weak_with_review_notice | term_normalization | - | False |
| similar_06 | similar_concept_false_trigger | 柔痓和痓病是一回事吗 | strong | term_normalization | safe:main_passages:ZJSHL-CH-007-P-0159 | False |
| similar_07 | similar_concept_false_trigger | 痉病和痓病是同一个词吗 | weak_with_review_notice | term_normalization | - | False |
...
| similar_09 | similar_concept_false_trigger | 结脉和促脉有什么区别 | strong | term_normalization | safe:main_passages:ZJSHL-CH-003-P-0028<br>safe:main_passages:ZJSHL-CH-010-P-0020<br>safe:main_passages:ZJSHL-CH-010-P-0019 | False |
| similar_10 | similar_concept_false_trigger | 促是什么意思 | strong | noise_stripped_query | safe:main_passages:ZJSHL-CH-008-P-0217<br>safe:main_passages:ZJSHL-CH-008-P-0219<br>safe:main_passages:ZJSHL-CH-003-P-0028 | True |
| similar_11 | similar_concept_false_trigger | 滑脉和革脉有什么不同 | weak_with_review_notice | term_normalization | - | False |
...
| similar_14 | similar_concept_false_trigger | 劳复和食复一样吗 | strong | term_normalization | safe:main_passages:ZJSHL-CH-009-P-0159<br>safe:main_passages:ZJSHL-CH-017-P-0050<br>safe:main_passages:ZJSHL-CH-017-P-0049 | False |
...
| similar_17 | similar_concept_false_trigger | 伤寒和温病有什么区别 | strong | term_normalization | safe:main_passages:ZJSHL-CH-006-P-0012<br>safe:main_passages:ZJSHL-CH-008-P-0195<br>safe:main_passages:ZJSHL-CH-009-P-0159 | False |
| similar_18 | similar_concept_false_trigger | 伤寒和暑病有什么区别 | strong | term_normalization | safe:main_passages:ZJSHL-CH-006-P-0012<br>safe:main_passages:ZJSHL-CH-008-P-0195<br>safe:main_passages:ZJSHL-CH-009-P-0159 | False |
| similar_19 | similar_concept_false_trigger | 伤寒和冬温有什么区别 | strong | term_normalization | safe:main_passages:ZJSHL-CH-008-P-0195<br>safe:main_passages:ZJSHL-CH-009-P-0159<br>safe:main_passages:ZJSHL-CH-009-P-0022 | False |
| similar_20 | similar_concept_false_trigger | 太阳病和伤寒是一回事吗 | strong | term_normalization | safe:main_passages:ZJSHL-CH-008-P-0195<br>safe:main_passages:ZJSHL-CH-008-P-0193<br>safe:main_passages:ZJSHL-CH-009-P-0002 | False |
| disabled_alias_01 | disabled_alias_recheck | 春温是什么意思 | weak_with_review_notice | noise_stripped_query | - | True |
| disabled_alias_02 | disabled_alias_recheck | 暑病者是什么意思 | strong | noise_stripped_query | safe:definition_terms:AHV-d1abf1c57ecf | False |
| disabled_alias_03 | disabled_alias_recheck | 寒疫是什么意思 | strong | noise_stripped_query | safe:definition_terms:AHV-bb8f9a64a54e | False |
| disabled_alias_04 | disabled_alias_recheck | 劳动病是什么 | strong | noise_stripped_query | safe:main_passages:ZJSHL-CH-017-P-0049<br>safe:main_passages:ZJSHL-CH-017-P-0050<br>safe:main_passages:ZJSHL-CH-009-P-0159 | True |
...
| non_definition_01 | non_definition_intent | 太阳病有哪些方？ | strong | term_normalization | safe:main_passages:ZJSHL-CH-008-P-0193<br>safe:main_passages:ZJSHL-CH-009-P-0002<br>safe:main_passages:ZJSHL-CH-008-P-0220 | False |
| non_definition_02 | non_definition_intent | 伤寒怎么治疗？ | strong | term_normalization | safe:main_passages:ZJSHL-CH-008-P-0195<br>safe:main_passages:ZJSHL-CH-009-P-0159<br>safe:main_passages:ZJSHL-CH-009-P-0022 | False |
| non_definition_03 | non_definition_intent | 温病与伤寒如何区分？ | strong | term_normalization | safe:main_passages:ZJSHL-CH-006-P-0012<br>safe:main_passages:ZJSHL-CH-006-P-0022<br>safe:main_passages:ZJSHL-CH-006-P-0046 | False |
| non_definition_04 | non_definition_intent | 霍乱用什么方？ | strong | term_normalization | safe:main_passages:ZJSHL-CH-016-P-0002<br>safe:main_passages:ZJSHL-CH-016-P-0004<br>safe:main_passages:ZJSHL-CH-016-P-0016 | False |
| non_definition_05 | non_definition_intent | 劳复应该怎么处理？ | strong | term_normalization | safe:main_passages:ZJSHL-CH-017-P-0048<br>safe:main_passages:ZJSHL-CH-017-P-0049 | False |
| non_definition_06 | non_definition_intent | 食复怎么治？ | strong | term_normalization | safe:main_passages:ZJSHL-CH-009-P-0159<br>safe:main_passages:ZJSHL-CH-017-P-0050<br>safe:main_passages:ZJSHL-CH-017-P-0049 | False |
| non_definition_07 | non_definition_intent | 结脉有什么方？ | strong | term_normalization | safe:main_passages:ZJSHL-CH-003-P-0028<br>safe:main_passages:ZJSHL-CH-010-P-0020<br>safe:main_passages:ZJSHL-CH-010-P-0019 | False |
| non_definition_08 | non_definition_intent | 革脉预后如何？ | refuse | term_normalization | - | False |
